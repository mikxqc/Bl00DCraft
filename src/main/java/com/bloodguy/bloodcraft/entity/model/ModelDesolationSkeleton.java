...
public class ModelDesolationSkeleton extends ModelZombie
{
    private static final String __OBFID = "CL_00000857";

    public ModelDesolationSkeleton()
    {
        this(0.0F);
    }

    public ModelDesolationSkeleton(float par1)
    {
    ...
    {
        this.aimedBow = ((EntityDesolationSkeleton)par1EntityLivingBase).getSkeletonType() == 1;
